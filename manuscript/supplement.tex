...
{\large Compound Climate-Pollution Effects on Hospital Admissions
in a Subtropical Metropolis: A Distributed Lag Non-Linear Analysis
of Temperature, PM$_{2{\cdot}5}$, and Respiratory Morbidity in Curitiba,
Brazil}\\[0.5em]
