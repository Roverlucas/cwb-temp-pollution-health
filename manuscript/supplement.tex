...
\paragraph{Adjusted sensitivity analysis (eTable~9)}
To assess potential confounding by co-pollutant exposure and
meteorological conditions, we fitted additional temperature DLNM models
including PM$_{2{\cdot}5}$ and/or relative humidity as linear
covariates. Adjusting for humidity alone ($N$=851) preserved the cold
effect (RR=1${\cdot}$18 [0${\cdot}$98--1${\cdot}$42] at P10),
virtually identical to the unadjusted estimate (RR=1${\cdot}$17).
However, models restricted to PM$_{2{\cdot}5}$-complete days showed
attenuated estimates (RR=0${\cdot}$82 [0${\cdot}$64--1${\cdot}$06],
$N$=683). This attenuation is likely a selection artifact: days with
valid PM$_{2{\cdot}5}$ data have systematically higher temperatures
($T_\mathrm{min}$ 15${\cdot}$3 vs 13${\cdot}$8\,°C, $p<$0${\cdot}$001;
eTable~10) and lower hospitalisations, thus underrepresenting the cold
tail of the distribution where the strongest effects are observed.
...
\paragraph{PM$_{2{\cdot}5}$ missingness mechanism (eTable~10)}
...
exclusions. To evaluate the missingness mechanism, we compared
$T_\mathrm{min}$, relative humidity, and daily hospitalisations
between days with and without valid PM$_{2{\cdot}5}$ (eTable~10).
Days with missing PM$_{2{\cdot}5}$ had significantly lower
temperatures ($-$1${\cdot}$4\,°C, $p<$0${\cdot}$001) and higher
hospitalisations ($+$3${\cdot}$4/day, $p<$0${\cdot}$001), indicating
that the mechanism is missing at random (MAR) conditional on
season/temperature. This pattern is consistent with increased sensor
downtime during winter months. Consequently, complete-case analyses
restricted to PM$_{2{\cdot}5}$-available days underrepresent cold
temperatures and produce attenuated temperature effect estimates.
The primary temperature DLNM, which uses the full dataset ($N$=1068)
without conditioning on PM$_{2{\cdot}5}$ availability, is not
...
\begin{table}[ht]
\centering
\caption{Sensitivity analysis adjusting for co-pollutant and
meteorological covariates. Cumulative RR at P10 of $T_\mathrm{min}$
(9${\cdot}$8\,°C), centred at MMT=17${\cdot}$8\,°C. Models include
PM$_{2{\cdot}5}$ and/or relative humidity as linear covariates
alongside the temperature cross-basis.}
\label{etab:adjusted_sensitivity}
\begin{tabular}{lrrrrr}
\toprule
Scenario & RR & 95\% CI & $\hat{\phi}$ & $N$ \\
\midrule
Main (unadjusted)            & 1${\cdot}$17 & 1${\cdot}$00--1${\cdot}$37 & 1${\cdot}$32 & 1068 \\
+ PM$_{2{\cdot}5}$ (linear)  & 0${\cdot}$82 & 0${\cdot}$64--1${\cdot}$06 & 1${\cdot}$32 &  683 \\
+ Humidity (linear)           & 1${\cdot}$18 & 0${\cdot}$98--1${\cdot}$42 & 1${\cdot}$27 &  851 \\
+ PM$_{2{\cdot}5}$ + Humidity & 0${\cdot}$68 & 0${\cdot}$44--1${\cdot}$06 & 1${\cdot}$28 &  563 \\
\bottomrule
\multicolumn{5}{l}{\footnotesize \textit{Note:} Models restricted to PM$_{2{\cdot}5}$-complete days underrepresent cold}\\
\multicolumn{5}{l}{\footnotesize temperatures (eTable~10), explaining the attenuated estimates. See Limitations.}
\end{tabular}
\end{table}
...
\bottomrule
\multicolumn{5}{l}{\footnotesize PM$_{2{\cdot}5}$ valid: $n$=697 days; missing: $n$=399 days. Missingness is MAR}\\
\multicolumn{5}{l}{\footnotesize (conditional on season/temperature), not MCAR. See main text Limitations.}
\end{tabular}
\end{table}
